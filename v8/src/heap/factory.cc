...
DEFINE_ERROR(HierarchyRequestError, hierarchy_request_error)
DEFINE_ERROR(DataCloneError, data_clone_error)
DEFINE_ERROR(NotSupportedError, notsupported_error)
